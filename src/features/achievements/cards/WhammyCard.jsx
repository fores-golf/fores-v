...
export default function DoubleWhammyCard({ 
  ...
  const themesCatalog = {
    '1/1': {
      ...
      topoFilter: "invert(1) sepia(1) saturate(600%) hue-rotate(0deg) brightness(1.1) contrast(1.6)", 
    ...
    '/5': {
      ...
      topoFilter: "invert(1) sepia(1) saturate(500%) hue-rotate(190deg) brightness(1.4) contrast(1.3)", 
    ...
    '/10': {
      ...
      topoFilter: "invert(0.9) grayscale(1) brightness(1.3) contrast(1.3)", 
    ...
    'Base': {
      name: "Clubhouse Core",
      bgClass: "bg-neutral-950 border-zinc-800",
      topoFilter: "opacity-10",
      towerGlow: "shadow-none",
      stampClass: "from-zinc-500 to-zinc-700",
      stampTextClass: "text-zinc-400",
      stampText: "CRISIS",
    }
  };
    ...
    <div className="w-full flex flex-col items-center justify-center font-sans">
      ...
      <div className="text-center mb-5 space-y-1">
        ...
        <p className="text-zinc-600 text-[9px] uppercase font-bold tracking-[0.3em]">
          Fores V • Premium Symmetrical Architecture
        </p>
      </div>
      ...
      <div className="relative w-[500px] h-[340px] cursor-pointer group" style={{ perspective: '1500px' }}>
        ...
        >
          {/* =========================================
             ...
             ========================================= */}
          <div className={`absolute inset-0 w-full h-full rounded-2xl overflow-hidden border-[6px] ${activeTheme.bgClass}`} 
            ...
            <div className="absolute inset-x-0 top-10 bottom-12 z-20 grid grid-cols-[76px_1fr_76px] gap-3 px-4 items-end h-[74%]">
              ...
              <div className={`relative flex flex-col items-center justify-end h-full w-full ${activeTheme.towerGlow} transition-shadow duration-300`}>
              ...
              <div className="relative bg-neutral-950/95 border-2 border-zinc-800/80 rounded-xl flex items-center justify-center shadow-[inset_0_4px_20px_rgba(0,0,0,0.95),0_10px_30px_rgba(0,0,0,0.8)] overflow-hidden h-full w-full group/video">
                ...
                <div className="absolute bottom-2 left-3 right-3 z-30 flex justify-between items-end opacity-40 group-hover/video:opacity-100 transition-opacity duration-300 pointer-events-none bg-gradient-to-t from-black via-black/90 to-transparent p-1.5 rounded-sm">
              ...
              {/* RIGHT TOWER: Hole 11 */}
              <div className="relative flex flex-col items-center justify-end h-full w-full transition-shadow duration-300">
                ...
                <div className="w-10 flex-1 bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950 border-x-2 border-zinc-800 relative overflow-hidden shadow-[inset_0_0_20px_rgba(0,0,0,0.95)]" style={{ backgroundImage: obsidianNoise }}>
                  <div className="absolute inset-x-0 top-1/4 bottom-0 bg-gradient-to-b from-red-600/90 via-red-950 to-neutral-950 shadow-[inset_0_4px_12px_rgba(220,38,38,0.6)] flex items-center justify-center animate-[pulse_1s_infinite_alternate]">
                    <span className="text-zinc-300 font-black text-[9px] tracking-[0.5em] uppercase font-mono [writing-mode:vertical-lr] drop-shadow-[0_0_8px_#ff3700] select-none">
                      DOUBLE BOGEY+
                    </span>
                  </div>
                </div>
            ...
            <div className="absolute bottom-2 left-4 right-4 z-40 flex items-center justify-between border-t border-zinc-800/60 pt-2 h-8">
              ...
              <div className={`bg-gradient-to-br ${activeTheme.stampClass} border border-white/10 px-3 py-0.5 rounded shadow-inner`}>
                <span className={`font-mono font-black text-[10px] tracking-tighter ${activeTheme.stampTextClass}`}>{activeTheme.stampText}</span>
              </div>
            </div>
          ...
          {/* =========================================
             ...
             ========================================= */}
          <div 
            className={`absolute inset-0 w-full h-full rounded-2xl shadow-2xl border-4 overflow-hidden ${activeTheme.bgClass} text-zinc-300`} 
            ...
            <div className="relative h-full flex flex-col p-5 z-10 justify-between">
              ...
              <div className="grid grid-cols-[120px_1fr] gap-4 items-center flex-1 py-2">
                <div className="bg-black/40 p-2.5 border border-zinc-800/80 rounded shadow-inner text-center space-y-2">
                  <div>
                    <div className="text-[6px] font-black Exploits tracker tracking-widest uppercase">HCP Ledger</div>
              ...
              <div className="text-center border-t border-zinc-800/80 pt-2">
                <div className="text-[6px] font-black text-zinc-500 uppercase tracking-[0.25em]">
                  Fores Banquet Collection • All Records Minted
                </div>
              </div>
            </div>
          </div>
